...
test-ios:
	macaca doctor
	platform=ios ${npm_bin}/macaca run --verbose --reporter macaca-reporter -d ./macaca-test/mobile-app-sample.test.js
travis-ios: install
...
test-android:
	macaca doctor
	platform=android ${npm_bin}/macaca run --verbose --reporter macaca-reporter -d ./macaca-test/mobile-app-sample.test.js
...
test-ios-safari:
	macaca doctor
	browser=safari ${npm_bin}/macaca run --verbose --reporter macaca-reporter -d ./macaca-test/mobile-browser-sample.test.js
...
test-android-chrome:
	macaca doctor
	browser=chrome ${npm_bin}/macaca run --verbose --reporter macaca-reporter -d ./macaca-test/mobile-browser-sample.test.js
...
test-desktop-electron:
	browser=electron ${npm_bin}/macaca run --verbose --reporter macaca-reporter -d ./macaca-test/desktop-browser-sample.test.js
...
test-desktop-puppeteer:
	browser=puppeteer ${npm_bin}/macaca run --verbose --reporter macaca-reporter -d ./macaca-test/desktop-browser-sample.test.js
